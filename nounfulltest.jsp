...
<% 	
	try {
        ...
        String temp_verb=(String)session.getAttribute("verb"); 
        String temp_noun=(String)session.getAttribute("noun"); 

   
        session.setAttribute("verb_full",verbon);
	    session.setAttribute("noun_full",nounon);
        ...
        stmt = con.createStatement(); // Statements allow to issue SQL queries to the database
         ...
         out.print("<b>Verb :</b>"); 
        out.print("<form method=\"post\" action=\"nountest.jsp\" name=\"productForm\">");
